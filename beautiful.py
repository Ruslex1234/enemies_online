...
guilds = ['Gold Reappers','Alzados','Diamond Reappers','Godslayers','Reappers','Watch Os','Unstopables','savage order','dinastia belica']
...
def sort_and_html(lista):
    ...
    html+='</head>'
    html+="<body>"
    html+="<center><h1>Guildbank Guilds</h1></center>"
    now = datetime.now()
